...
namespace GaussianSplatting.Runtime
{
    class GaussianSplatRenderSystem
    {
        ...
        void OnPreCullCamera(Camera cam)
        {
            ...
            //     // In Play-Mode: use whatever the user set in QualitySettings (clamped to ≥1)
            //     msaa = Mathf.Max(QualitySettings.antiAliasing, 1);
            // }
            // else {
            //     // In Edit-Mode (Scene View, previews, etc): force single-sample
            //     msaa = 1;
            // }
            ...
            m_CommandBuffer.GetTemporaryRT(GaussianSplatRenderer.Props.GaussianSplatRT, desc);
